...
alias inbox='nvim ~/documents/gtd/inbox.md'
alias next='nvim ~/documents/gtd/next-actions.md'
alias someday='nvim ~/documents/gtd/someday-maybe.md'
alias media='nvim ~/documents/gtd/projects/media.md'
